...
// const [obj1,obj2,obj3,obj4,obj5]=data
const ind=data.map( ({title,description,image_url})=>{
    const rew=document.getElementById("card"+num++)
    rew.innerHTML=`<img src="${image_url}" class="card-img-top" alt="...">
    <div class="card-body">
